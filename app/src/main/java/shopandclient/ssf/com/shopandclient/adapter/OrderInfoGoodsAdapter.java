...
public class OrderInfoGoodsAdapter extends RecyclerView.Adapter {
    private Context context;
    private ArrayList<OrderDetailInfoBean.DataBean.OrderDetailBean.OrderInfoBean> orderDetailBeans;


    public OrderInfoGoodsAdapter(Context context, ArrayList<OrderDetailInfoBean.DataBean.OrderDetailBean.OrderInfoBean> orderDetailBeans) {
