 ...
 */
public class ReteryAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<OrderInStoreBean> orderDetailBeans;

    public ReteryAdapter(Context context, ArrayList<OrderInStoreBean> orderDetailBeans) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ViewHodler hodler;
        if(convertView==null){
            ...
            convertView=LayoutInflater.from(context).inflate(R.layout.item_retery_goods_info,parent,false);
