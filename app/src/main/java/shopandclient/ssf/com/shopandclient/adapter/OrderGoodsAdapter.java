...
public class OrderGoodsAdapter extends RecyclerView.Adapter {
    ...
    public OrderGoodsAdapter(Context context, ArrayList<OrderDetailBean> orderDetailBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new GoodsViewHolder(LayoutInflater.from(context).inflate(R.layout.item_goods_inorder,parent,false));
    }
