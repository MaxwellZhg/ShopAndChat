...
public class ForbinGroupMemberAdapter extends RecyclerView.Adapter {
    private ArrayList<GroupInfoBean.DataBean.ListBean> arrayList;
    private Context context;

    public ForbinGroupMemberAdapter(Context context, ArrayList<GroupInfoBean.DataBean.ListBean> arrayList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ((ForbinGroupMemberAdapter.AddGroupViewHolder) holder).setData(position);
    }
    ...
    class AddGroupViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            if(arrayList.get(position).getIfForbid()==1){
            ...
            cb_into_group.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (arrayList.get(position).getIfForbid()==0) {
                        arrayList.get(position).setIfForbid(1);
                        cb_into_group.setBackground(context.getResources().getDrawable(R.drawable.icon_chat_check));
                    } else {
                        arrayList.get(position).setIfForbid(0);
